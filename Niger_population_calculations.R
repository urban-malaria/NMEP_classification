...
Niger_lGAshp <- sf::st_read(file.path(pathLGA, "NGA_LGAs.shp"))
sf::sf_use_s2(FALSE)
...
#                    labels = "AUTO") 
# 
# FigDir <- file.path(DriveDir,"/urban_malaria/projects/urban_microstratification/Shiny App/Plots/deprioritization_scenarios")
# 
# ggsave(paste0(FigDir,"/", Sys.Date(),"_Niger_reprioritization_scenarios.pdf"), p_all, width = 13, height = 14)
