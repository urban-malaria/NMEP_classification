...
p1<- ggplot() +
  geom_sf(data = combined_plot2, aes(geometry = geometry, fill = status)) +
...
ggsave(paste0(FigDir,"/", "urban_50_75", "/", Sys.Date(),"_Taraba_reprioritization_scenarios.pdf"), p_high_urban, width = 13, height = 14)
